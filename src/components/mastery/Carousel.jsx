  ...
  return (
    <div className="w-full h-full flex flex-row items-end justify-center">
      ...
      <div className="conversion_card-content-wrapper w-full h-[30%] opacity-1 flex justify-start items-end -mb-[2px]">
        <div className="relative opacity-98 p-8 relative max-tablet:p-5">
          <div className="-tracking-[0.03rem] text-2xl font-[600] leading-[1.2] text-secondary flex items-center gap-3 max-tablet:text-lg max-tablet:gap-2">
            <svg
