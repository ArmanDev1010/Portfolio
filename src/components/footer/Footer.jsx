    ...
    <div className="bg-primary pt-24 max-tablet:pt-20 max-small:!pt-[4rem] relative">
      <div className="px-[5%] relative">
        <div className="max-w-[80rem] w-full !mx-auto relative">
          <div className="w-full pt-[2.5rem] pb-[3rem] text-[0.875rem] leading-[1.2] grid items-center justify-between auto-cols-[1fr] grid-cols-[1fr_1fr] grid-rows-[auto] border-t-[2px] border-t-[#1a1a1e] tracking-[-0.02625rem] text-[#a0a0ab] gap-[16px] max-medium:gap-[1.5rem] max-medium:flex max-medium:flex-col">
            <div className="max-phone:w-[350px] max-smal:w-[280px]">
              <a href="#hero">
